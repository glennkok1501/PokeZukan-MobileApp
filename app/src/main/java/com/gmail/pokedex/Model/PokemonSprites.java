...
public class PokemonSprites implements Serializable {
    ...
    public PokemonOther getOther() {
        return other;
    }

    public void setOther(PokemonOther other) {
        this.other = other;
    }
    ...
    public PokemonSprites(String front_default, String front_shiny, String front_female, String front_shiny_female, String back_default, String back_shiny, String back_female, String back_shiny_female, PokemonOther other) {
        this.front_default = front_default;
        this.front_shiny = front_shiny;
        this.front_female = front_female;
        this.front_shiny_female = front_shiny_female;
